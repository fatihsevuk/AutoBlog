...
<body>
	<div class="blog-masthead">
		<div class="container">
			<nav class="blog-nav">
				<a class="blog-nav-item active" href="${pageContext.request.contextPath}/login">Giriş Yap</a> 
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-7 blog-main"><form:form id="registerForm" method="POST"
					modelAttribute="registerForm"
				>
					<table>
					
					<tr>
							<td><form:label path="title">Blog Başlığı:</form:label></td>
							<td><form:input path="title" /> <font color="red">
									<form:errors path="title" delimiter=" ," />
							</font></td>
					</tr>
					
					<tr>
							<td><form:label path="description">Blog Açıklaması:</form:label></td>
							<td><form:input path="description" /> <font color="red">
					...
					<tr>
							<td><form:label path="rePassword">Parola Yeniden:</form:label></td>
							<td><form:input path="rePassword" type="password" /> <font color="red"><form:errors
										path="password" delimiter=" ,"
									/></font></td>
					</tr>
						...
						<tr>
							<td colspan="2"><input type="submit" value="Kayıt" /></td>
							<td></td>
							<td></td>
					</tr>
					</table>
