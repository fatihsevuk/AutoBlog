	...
	<div class="blog-masthead">
		<div class="container">
			<nav class="blog-nav"><a class="blog-nav-item active"
				...
				<a class="blog-nav-item" href="${pageContext.request.contextPath}/create">Yazı Yaz</a> <a
	...
	<div class="container">
		...
		<div class="row">
			...
			<c:forEach
					...
					<div class="blog-post">
						<h2 class="blog-post-title"><c:out
								value="${post.title}" /></h2>
						<p class="blog-post-meta"><c:out value="${post.date}" />
							by <b><c:if
							...
							<b>
							Kategori:<a href="#"><c:out value="${post.category }"/></a>
							
							</b>
							
							<b>
							<c:if test="${ post.draft == true}">
								<c:out value="Taslak yazı" />
							</c:if> 
							
							</b>
							
							<c:set var="urlWithPostId1" value="post/${post.id }" />
							<c:set var="body" value="${fn:substring(post.body, 0, 240)}" /> 
							
							</p> <c:out value="${body}" />
							
							
							<a href="${pageContext.request.contextPath}/${urlWithPostId1} ">Devamını Oku</a>
				...
				<div class="sidebar-module">
					<h4>Son Beş Post</h4> <c:forEach items="${latest5Posts}" var="post">
						...
						<ol class="list-unstyled">
							<li><a
								href="${pageContext.request.contextPath}/${urlWithPostId} "><c:out
										value=" ${post.title }" /></a></li>
						</ol>
